...
const questions = [
  {
    id: 1,
    name: "SAP Engineer",
    description: "Basic of SAP Concepts",
    difficulty: "Easy",
  },
  {
    id: 2,
    name: "SAP Architect",
    description: "SAP S/4HANA , SAP Fiori, SAP SCM, SAP CRM , SAP Security",
    difficulty: "Medium",
  },
];
              ...
              {step === 1 ? (
                ...
                >
                  <h2 className="text-4xl font-bold text-[#1E2B3A]">
                    Select your technology and proficiency
                  </h2>
                  <p className="text-[14px] leading-[20px] text-[#1a2b3b] font-normal my-4">
                  Hukum has organized numerous questions categorized by technology streams. Please select your stream to begin the AI interview.                  </p>
                  <div>
