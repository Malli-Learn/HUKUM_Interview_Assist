      ...
      <div className="min-h-[100vh] sm:min-h-screen w-screen flex flex-col relative bg-[#F2F3F5] font-inter overflow-hidden">
        ...
        <main className="flex flex-col justify-center h-[90%] static md:fixed w-screen overflow-hidden grid-rows-[1fr_repeat(3,auto)_1fr] z-[100] pt-[30px] pb-[320px] px-4 md:px-20 md:py-0">
          ...
          <motion.h1
            ...
            className="relative md:ml-[-10px] md:mb-[37px] font-extrabold text-[16vw] md:text-[75px] font-inter text-[#1E2B3A] leading-[0.9] tracking-[-2px] z-[100]"
          >
            Elevate your <br />
            tech interviews with <span className="text-[#407BBF]"> HUKUM </span>
          ...
          <div className="flex gap-[15px] mt-8 md:mt-0">
            ...
            >
              <Link
                href="/demo"
                className="group rounded-full px-4 py-2 text-[13px] font-semibold transition-all flex items-center justify-center bg-blue text-black no-underline active:scale-95 scale-100 duration-75"
                style={{
                  boxShadow: "0 1px 1px #0c192714, 0 1px 3px #2196F3",
                }}
              >
                <span className="mr-2 text-black"> Try it out a Demo</span>
                <svg
                  className="w-5 h-5"
                  viewBox="0 0 24 24"
                ...
                >
                  <path
                    d="M13.75 6.75L19.25 12L13.75 17.25Z"
                    fill="#2196F3"
                  />
                  <path
                    d="M19 12H4.75"
        ...
        <motion.canvas
          ...
          id="gradient-canvas"
          data-transition-in
          className="z-50 fixed top-0 right-[-2px] w-[80%] md:w-1/2 h-screen bg-[#2196F3]"
        ></motion.canvas>
